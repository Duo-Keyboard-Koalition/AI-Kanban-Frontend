  ...
  return (
    <div
      className={`flex-shrink-0 w-80 bg-gray-100 rounded-lg p-4 transition-colors ${
        isDragOver ? 'bg-blue-50 border-2 border-blue-400' : ''
      }`}
      ...
      {showForm ? (
        <div className="bg-white p-3 rounded-lg shadow-sm border border-gray-200">
          ...
          <textarea
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-md mb-2 text-sm resize-none"
            rows={2}
          />
        ...
        <button
          ...
          className="w-full px-3 py-2 text-sm text-gray-600 hover:bg-gray-200 rounded-md transition-colors"
        >
          + Add Task
        </button>
      )}
